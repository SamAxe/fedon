...
var bind, editor, emit, exifr, md5, resizeImage;
md5 = require('./md5');
exifr = require('exifr');
    ...
    return img.on('load', function () {
      ...
      if ($(this).attr('src') !== item.url) {
        ...
        if (!item.url.startsWith('/assets/plugins/image/')) {
          ...
          return $(flag).on('click', function (e) {
            var imageSource;
            e.preventDefault();
            imageSource = e.target.parentNode.previousSibling.src;
            return fetch(imageSource).then(function (response) {
              if (response.ok) {
                return response.blob();
              }
              ...
              return reader.onload = /*#__PURE__*/function () {
                var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(loadEvent) {
                  var archiveFilename, archiveImage, imageDataURL;
                      ...
                      case 3:
                        ...
                        return fetch(archiveImage).then(function (response) {
                          ...
                          return fetch("/plugin/image/upload/".concat(archiveFilename), {
                            ...
                            return wiki.pageHandler.put($page, {
                              type: 'edit',
                              id: item.id,
                              item: item
                            });
...
editor = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(spec) {
    var $imageEditor, $item, escape, exifrAvailable, filename, focusoutHandler, imageCaption, imageDataURL, imageLocation, imageSize, imageSourceURL, imgCurrentSize, imgPossibleSize, imgURL, item, keydownHandler, newImage, original, pasteLocation, ref, ref1;
      ...
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 7:
          ...
          focusoutHandler = /*#__PURE__*/function () {
            ...
            return function focusoutHandler(_x4) {
        ...
        case 26:
          imgPossibleSize = _context4.sent;
          imgURL = imageDataURL;
          console.log('size/URL', {
            imgPossibleSize: imgPossibleSize,
            imgURL: imgURL
          });
          _context4.next = 34;
          break;
        ...
        case 34:
          ...
          return _context4.abrupt("return", $imageEditor.trigger('focus'));
        case 46:
        case "end":
